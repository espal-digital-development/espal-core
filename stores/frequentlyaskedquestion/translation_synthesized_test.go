...
func TestTranslationTable(t *testing.T) {
	translation := frequentlyaskedquestion.NewTranslationEntity()
...
func TestTranslationFrequentlyAskedQuestionID(t *testing.T) {
	translation := frequentlyaskedquestion.NewTranslationEntity()
	testValue := "testValue"
	translation.SetFrequentlyAskedQuestionID(testValue)
	if testValue != translation.FrequentlyAskedQuestionID() {
		t.Fatal("Getter did not return the Set value")
	}
}
