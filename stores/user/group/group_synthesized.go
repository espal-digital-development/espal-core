...
func (group *Group) UserRights() string {
	return group.userRights
}

// SetUserRights sets the userRights.
func (group *Group) SetUserRights(userRights string) {
	group.userRights = userRights
}

// Currencies returns currencies.
func (group *Group) Currencies() string {
	return group.currencies
}

// SetCurrencies sets the currencies.
func (group *Group) SetCurrencies(currencies string) {
	group.currencies = currencies
}

// LocalizedName returns localizedName.
func (group *Group) LocalizedName() *string {
	return group.localizedName
}

// SetLocalizedName sets the localizedName.
func (group *Group) SetLocalizedName(localizedName *string) {
	group.localizedName = localizedName
}
