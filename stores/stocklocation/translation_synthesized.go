...
func (t *Translation) StockLocationID() string {
	return t.stockLocationID
}

// SetStockLocationID sets the stockLocationID.
func (t *Translation) SetStockLocationID(stockLocationID string) {
	t.stockLocationID = stockLocationID
}
