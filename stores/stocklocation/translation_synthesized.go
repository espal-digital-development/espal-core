...
type TranslationEntity interface {
	...
	SetStockLocationID(stockLocationID string)
}
...
// StockLocationID returns stockLocationID.
func (translation *Translation) StockLocationID() string {
	return translation.stockLocationID
}

// SetStockLocationID sets the stockLocationID.
func (translation *Translation) SetStockLocationID(stockLocationID string) {
	translation.stockLocationID = stockLocationID
}
