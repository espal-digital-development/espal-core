...
func (translation *Translation) GroupID() string {
	return translation.groupID
}

// SetGroupID sets the groupID.
func (translation *Translation) SetGroupID(groupID string) {
	translation.groupID = groupID
}
