...
func (t *Translation) DeliveryMethodID() string {
	return t.deliveryMethodID
}

// SetDeliveryMethodID sets the deliveryMethodID.
func (t *Translation) SetDeliveryMethodID(deliveryMethodID string) {
	t.deliveryMethodID = deliveryMethodID
}
