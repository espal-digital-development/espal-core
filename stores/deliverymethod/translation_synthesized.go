...
func (translation *Translation) DeliveryMethodID() string {
	return translation.deliveryMethodID
}

// SetDeliveryMethodID sets the deliveryMethodID.
func (translation *Translation) SetDeliveryMethodID(deliveryMethodID string) {
	translation.deliveryMethodID = deliveryMethodID
}
