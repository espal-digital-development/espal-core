...
func (translation *Translation) StoreID() string {
	return translation.storeID
}

// SetStoreID sets the storeID.
func (translation *Translation) SetStoreID(storeID string) {
