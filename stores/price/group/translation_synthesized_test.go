...
import (
	...
	"github.com/espal-digital-development/espal-core/stores/price/group"
)

func TestTranslationTable(t *testing.T) {
	translation := group.NewTranslationEntity()
...
func TestTranslationGroupID(t *testing.T) {
	translation := group.NewTranslationEntity()
	testValue := "testValue"
	translation.SetGroupID(testValue)
	if testValue != translation.GroupID() {
		t.Fatal("Getter did not return the Set value")
	}
}
