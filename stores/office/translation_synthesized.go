...
// OfficeID returns officeID.
func (translation *Translation) OfficeID() string {
	return translation.officeID
}

// SetOfficeID sets the officeID.
func (translation *Translation) SetOfficeID(officeID string) {
	translation.officeID = officeID
}
