...
func TestLineReturnOrderReceivingID(t *testing.T) {
	line := receiving.NewLineEntity()
	testValue := "testValue"
	line.SetReturnOrderReceivingID(testValue)
	if testValue != line.ReturnOrderReceivingID() {
		t.Fatal("Getter did not return the Set value")
	}
}

func TestLineReturnOrderLineID(t *testing.T) {
	line := receiving.NewLineEntity()
	testValue := "testValue"
	line.SetReturnOrderLineID(&testValue)
	if &testValue != line.ReturnOrderLineID() {
		t.Fatal("Getter did not return the Set value")
	}
}
