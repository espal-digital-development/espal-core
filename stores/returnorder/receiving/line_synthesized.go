...
func (line *Line) ReturnOrderReceivingID() string {
	return line.returnOrderReceivingID
}

// SetReturnOrderReceivingID sets the returnOrderReceivingID.
func (line *Line) SetReturnOrderReceivingID(returnOrderReceivingID string) {
	line.returnOrderReceivingID = returnOrderReceivingID
}

// ReturnOrderLineID returns returnOrderLineID.
func (line *Line) ReturnOrderLineID() *string {
	return line.returnOrderLineID
}

// SetReturnOrderLineID sets the returnOrderLineID.
func (line *Line) SetReturnOrderLineID(returnOrderLineID *string) {
	line.returnOrderLineID = returnOrderLineID
}
