...
// BlockID returns blockID.
func (translation *Translation) BlockID() string {
	return translation.blockID
}

// SetBlockID sets the blockID.
func (translation *Translation) SetBlockID(blockID string) {
