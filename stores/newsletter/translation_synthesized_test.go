...
func TestTranslationTable(t *testing.T) {
	translation := newsletter.NewTranslationEntity()
...
func TestTranslationNewsletterID(t *testing.T) {
	translation := newsletter.NewTranslationEntity()
	testValue := "testValue"
	translation.SetNewsletterID(testValue)
	if testValue != translation.NewsletterID() {
		t.Fatal("Getter did not return the Set value")
	}
}
