...
func TestTranslationTable(t *testing.T) {
	translation := reseller.NewTranslationEntity()
...
func TestTranslationResellerID(t *testing.T) {
	translation := reseller.NewTranslationEntity()
	testValue := "testValue"
	translation.SetResellerID(testValue)
	if testValue != translation.ResellerID() {
		t.Fatal("Getter did not return the Set value")
	}
}
