...
import (
	...
	"github.com/espal-digital-development/espal-core/stores/purchaseorder/receiving"
)

func TestLineTable(t *testing.T) {
	line := receiving.NewLineEntity()
	if line.TableName() == "" {
...
func TestLineReceivingID(t *testing.T) {
	line := receiving.NewLineEntity()
	testValue := "testValue"
	line.SetReceivingID(testValue)
	if testValue != line.ReceivingID() {
		t.Fatal("Getter did not return the Set value")
	}
}

func TestLineLineID(t *testing.T) {
	line := receiving.NewLineEntity()
	testValue := "testValue"
	line.SetLineID(&testValue)
	if &testValue != line.LineID() {
		t.Fatal("Getter did not return the Set value")
	}
}
