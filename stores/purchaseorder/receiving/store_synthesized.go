...
func (s *ReceivingsStore) fetch(query string, withCreators bool, params ...interface{}) (result []*Receiving, ok bool, err error) {
	...
	for rows.Next() {
		...
		r := newReceiving()
		fields := []interface{}{&r.id, &r.createdByID, &r.updatedByID, &r.createdAt, &r.updatedAt, &r.comments}
		if withCreators {
