...
func (translation *Translation) ForumID() string {
	return translation.forumID
}

// SetForumID sets the forumID.
func (translation *Translation) SetForumID(forumID string) {
	translation.forumID = forumID
}
