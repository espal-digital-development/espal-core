...
func (t *Translation) ShippingWindowID() string {
	return t.shippingWindowID
}

// SetShippingWindowID sets the shippingWindowID.
func (t *Translation) SetShippingWindowID(shippingWindowID string) {
	t.shippingWindowID = shippingWindowID
}
