...
type TranslationEntity interface {
	...
	SetShippingWindowID(shippingWindowID string)
}
...
// ShippingWindowID returns shippingWindowID.
func (translation *Translation) ShippingWindowID() string {
	return translation.shippingWindowID
}

// SetShippingWindowID sets the shippingWindowID.
func (translation *Translation) SetShippingWindowID(shippingWindowID string) {
	translation.shippingWindowID = shippingWindowID
}
