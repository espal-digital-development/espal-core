...
func (translation *Translation) NewsArticleID() string {
	return translation.newsArticleID
}

// SetNewsArticleID sets the newsArticleID.
func (translation *Translation) SetNewsArticleID(newsArticleID string) {
	translation.newsArticleID = newsArticleID
}
