...
func (translation *Translation) BlogPostID() string {
	return translation.blogPostID
}

// SetBlogPostID sets the blogPostID.
func (translation *Translation) SetBlogPostID(blogPostID string) {
	translation.blogPostID = blogPostID
}
