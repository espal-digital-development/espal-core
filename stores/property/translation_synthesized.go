...
func (translation *Translation) PropertyID() string {
	return translation.propertyID
}

// SetPropertyID sets the propertyID.
func (translation *Translation) SetPropertyID(propertyID string) {
	translation.propertyID = propertyID
}
