...
func TestTranslationTable(t *testing.T) {
	translation := property.NewTranslationEntity()
...
func TestTranslationPropertyID(t *testing.T) {
	translation := property.NewTranslationEntity()
	testValue := "testValue"
	translation.SetPropertyID(testValue)
	if testValue != translation.PropertyID() {
		t.Fatal("Getter did not return the Set value")
	}
}
