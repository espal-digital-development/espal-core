...
// MenuID returns menuID.
func (translation *Translation) MenuID() string {
	return translation.menuID
}

// SetMenuID sets the menuID.
func (translation *Translation) SetMenuID(menuID string) {
