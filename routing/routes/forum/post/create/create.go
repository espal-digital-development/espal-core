...
import (
	page "github.com/espal-digital-development/espal-core/pages/forum/post/create"
...
func (route *Route) Handle(context contexts.Context) {
	...
	route.createPageFactory.NewPage(context, forum).Render()
}

// New returns a new instance of Route.
func New(regularExpressionsRepository regularexpressions.Repository, forumStore forum.Store, createPageFactory page.Factory) *Route {
	return &Route{
