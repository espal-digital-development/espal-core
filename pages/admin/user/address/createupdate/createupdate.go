...
func (createUpdate *CreateUpdate) NewPage(context contexts.Context, userAddress *address.Address, user *user.User, language contexts.Language, form base.Form, displayTitle string) Template {
	page := &Page{
