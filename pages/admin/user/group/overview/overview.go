...
type Factory interface {
	NewPage(context contexts.Context, language contexts.Language, actions pageactions.Actions, filter filters.Filter, userGroups []*group.Group, canUpdate bool, canDelete bool) Template
}
...
func (overview *Overview) NewPage(context contexts.Context, language contexts.Language, actions pageactions.Actions, filter filters.Filter, userGroups []*group.Group, canUpdate bool, canDelete bool) Template {
	page := &Page{
		language:        language,
		actions:         actions,
		filter:          filter,
