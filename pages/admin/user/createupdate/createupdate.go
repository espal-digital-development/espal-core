...
type Factory interface {
	NewPage(context contexts.Context, user *user.User, language contexts.Language, form base.Form, displayTitle string) Template
}
...
func (createUpdate *CreateUpdate) NewPage(context contexts.Context, user *user.User, language contexts.Language, form base.Form, displayTitle string) Template {
	page := &Page{
		user:            user,
		language:        language,
		form:            form,
