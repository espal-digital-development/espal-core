...
func (createUpdate *CreateUpdate) NewPage(context contexts.Context, userContact *contact.Contact, user *user.User, language contexts.Language, form base.Form, displayTitle string) Template {
	page := &Page{
