...
type Factory interface {
	NewPage(context contexts.Context, language contexts.Language, actions pageactions.Actions, filter filters.Filter, users []*user.User, canUpdate bool, canDelete bool) Template
}
