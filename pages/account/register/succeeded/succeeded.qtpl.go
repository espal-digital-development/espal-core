...
//line account/register/succeeded/succeeded.qtpl:1
package succeeded
...
//line account/register/succeeded/succeeded.qtpl:3
func (page *Page) StreamTitle(qw422016 *qt422016.Writer) {
//line account/register/succeeded/succeeded.qtpl:3
	qw422016.E().S(page.Translate("registerAccountSucceeded"))
//line account/register/succeeded/succeeded.qtpl:3
}
...
//line account/register/succeeded/succeeded.qtpl:5
func (page *Page) StreamContent(qw422016 *qt422016.Writer) {
//line account/register/succeeded/succeeded.qtpl:5
	qw422016.N().S(`<div class="simpleBox"><h1>`)
//line account/register/succeeded/succeeded.qtpl:7
	qw422016.E().S(page.Translate("registerAccountSucceeded"))
//line account/register/succeeded/succeeded.qtpl:7
	qw422016.N().S(`</h1>`)
//line account/register/succeeded/succeeded.qtpl:8
	qw422016.E().S(page.Translate("thanksForRegistering_"))
//line account/register/succeeded/succeeded.qtpl:8
	qw422016.N().S(`</div>`)
//line account/register/succeeded/succeeded.qtpl:10
}
